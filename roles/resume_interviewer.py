...
class ResumeInterviewer(BaseRole):
    def get_system_message(self, config=None):
        if config:
            try:
                ...
                return SystemMessage(content=f"""As an expert interviewer specializing in technical roles, your name is Mike. You are tasked with conducting a comprehensive and engaging interview with a candidate named candidate, based on the following Resume:  
    ...
    def _get_default_message(self):
        return SystemMessage(content=f"""As an expert interviewer specializing in technical roles, your name is Mike. You are tasked with conducting a comprehensive and engaging interview with a candidate named candidate, based on the following Job Description:  
